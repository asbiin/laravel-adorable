...
class LaravelAdorableTest extends FeatureTestCase
{
    ...
    public function it_generate_square_avatar()
    {
        ...
        $this->assertEquals($avatar, $image);
        $this->assertTrue($cache->has('adorable.042d0af447682411dd93493f94cf1b7a9aa1ceb26a8c7b75d2a88ba07dbcc89d'));
        $this->assertEquals($avatar, $cache->get('adorable.042d0af447682411dd93493f94cf1b7a9aa1ceb26a8c7b75d2a88ba07dbcc89d'));
    }
    ...
    public function it_generate_circle_avatar()
    {
        ...
        $this->assertEquals($avatar, $cache->get('adorable.b6cb42a351d2b3786df2efefaca062d032a67d7e1da38260102e1bdd35965e97'));
    }
}
